package pers.lcy.graduationdesign.util.HackClass;
 ...
 * 2. 几个方法的返回参数类型：java.util.Scanner -> pers.lcy.graduationdesign.util.HackClass.HackScanner
 *
...
public final class HackScanner implements Iterator<String>, Closeable {
    ...
    private HackScanner(Path source, Charset charset)  throws IOException {
     ...
     * @return this scanner
     */
    public pers.lcy.graduationdesign.util.HackClass.HackScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public pers.lcy.graduationdesign.util.HackClass.HackScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public pers.lcy.graduationdesign.util.HackClass.HackScanner useLocale(Locale locale) {
     ...
     */
    public pers.lcy.graduationdesign.util.HackClass.HackScanner useRadix(int radix) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public pers.lcy.graduationdesign.util.HackClass.HackScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public pers.lcy.graduationdesign.util.HackClass.HackScanner skip(String pattern) {
     ...
     * @since 1.6
     */
    public pers.lcy.graduationdesign.util.HackClass.HackScanner reset() {
